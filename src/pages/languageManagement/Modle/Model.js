...
export default function Model({formData,setFormData,errorCreate,handleChange,handleSubmit,setopenAddmodel,openAddmodel, handleClose}) {
    ...
    <div>
      ...
      <div className="animate__animated animate__fadeInDown animate__faster bg-[#f8f8fb]  md:w-[35rem] w-full  mx-auto rounded shadow-lg  overflow-y-auto mt-2">
        ...
        <div className="flex items-center justify-between p-6 py-2 bg-[#1E5EFF] border-b">
          <p className="text-xl font-bold text-white uppercase">Add Language</p>
       ...
       <IoClose/>
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="title">Short Name:</label>
          <input 
            type="text" 
            id="shortName" 
            name="shortName" 
  ...
  {errorCreate&&errorCreate["shortName"]&&<div className=' text-sm text-red-500'>{errorCreate.shortName}</div>}
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="scriptName">Script :</label>
          <input 
            type="text" 
            id="scriptName" 
            name="scriptName" 
